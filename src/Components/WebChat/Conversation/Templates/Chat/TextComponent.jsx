...
const TextComponent = (props = {}) => {
  ...
  const renderMessageBody = (inputData, mentionedLst) => {
    ...
    const formattedText = htmlToReactParser.parse(handleMentionedUser(getFormattedText(textData), mentionedUsers, !isSender && data.userId, null, messageObject.chatType));
