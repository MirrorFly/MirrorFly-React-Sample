...
describe(">>> VideoPlayer Test case <<<", () => {
    ...
    it('div click play audio', () => {
        wrapper.find('div[data-jest-id="jest_onClick"]').simulate('click');
    });

    it('div click pause audio', () => {
        wrapper.find('div[data-jest-id="jest_onClick"]').simulate('click');
    });

    it('div click pause audio', () => {
        wrapper.find('video[data-msgid="12345"]').simulate('ended');
    });
